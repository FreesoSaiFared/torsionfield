...
class Handler(BaseHTTPRequestHandler):
    ...
    def end_headers(self):
        # Extension pages from several independently installed browser profiles use
        # this relay. Standards-based CORS keeps localhost host permission out of
        # those manifests and makes transport independent of extension reloads.
...
def main() -> int:
    ...
    print(f"TF Browser Bridge v3 {VERSION} http://{HOST}:{args.port}", flush=True)
