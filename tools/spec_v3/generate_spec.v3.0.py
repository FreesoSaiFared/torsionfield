...
PARTS = [
    ...
    ("V", "Participatory work, verification, and governance", range(30, 37)),
    ("VI", "References", range(37, 38)),
]
...
SUMMARIES.update({
    ...
    37: "Lists the primary documentation and source projects used as implementation and interoperability references.",
})
...
def status_for(number: int) -> str:
    ...
    if 25 <= number <= 32 or number in {34, 35}:
...
<header class="site-head">
  ...
  <nav aria-label="Specification actions">
    ...
    <a href="/spec/torsionfield-runtime-spec-v3.0-print.pdf">PDF</a>
    <a href="/spec/torsionfield-runtime-spec-v3.0.md" download>Markdown</a>
...
<section class="cover" aria-labelledby="spec-title">
  ...
  <p class="cover-note">This edition rewrites the document for navigability, implementation traceability, accessible screen reading, and compact paged-media output. All 37 source sections are retained and mapped. Normative clauses receive stable requirement identifiers without changing their force.</p>
</section>
...
This edition rewrites the complete v2.4 specification for clarity, navigability, implementation traceability, accessible screen reading, and compact paged-media output. All 37 source sections are retained and mapped. Normative clauses keep their original force.
...
'''
    ...
    (OUT / "torsionfield-runtime-spec-v3.0.md").write_text(markdown_doc, encoding="utf-8")
