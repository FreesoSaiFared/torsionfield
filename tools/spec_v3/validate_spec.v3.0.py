...
required_files = [
    "spec.css", "spec.js", "torsionfield-runtime-spec-v3.0.md",
...
assert result["sectionElements"] == 37
assert result["partOpeners"] == 6
assert not duplicates
assert len(source_map) == 37
assert len(requirements) > 0
assert not missing
assert result["hasSection36"] and result["hasSection37"]
