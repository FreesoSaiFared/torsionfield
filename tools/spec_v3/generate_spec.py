...
SOURCE = ROOT / "source-spec-v3.2.txt"
...
PARTS = [
    ...
    ("V", "Participatory work, verification, and governance", range(30, 39)),
...
SUMMARIES.update({
    ...
    38: "Defines adaptive repository intelligence, rejected-proposal and fork analysis, temporal graph memory, and evidence-backed external-code selection.",
...
def status_for(number: int) -> str:
    ...
    if 25 <= number <= 32 or number in {34, 35, 37, 38}:
...
<header class="site-head">
  ...
  <nav aria-label="Specification actions">
    ...
    <a href="/spec/torsionfield-runtime-spec-v3.2-print.pdf">PDF</a>
    <a href="/spec/torsionfield-runtime-spec-v3.2.md" download>Markdown</a>
...
<section class="cover" aria-labelledby="spec-title">
  ...
  <dl class="cover-meta">
    ...
    <div><dt>Source</dt><dd>Complete v2.4 specification plus Participant Edge Plane and ForkSense amendments</dd></div>
  </dl>
  <p class="cover-note">This edition rewrites the document for navigability, implementation traceability, accessible screen reading, and compact paged-media output. All 39 sections are retained and mapped. Normative clauses receive stable requirement identifiers without changing their force.</p>
</section>
...
'''
    ...
    manifest = {
        ...
        "source": {
            ...
            "version": "2.4+participant-edge+forksense",
    ...
    (OUT / "torsionfield-runtime-spec-v3.2.md").write_text(markdown_doc, encoding="utf-8")
    ...
    rounds = [
        {
            ...
            "change": "Added a new cover, executive orientation, direct vertical-slice path, six document parts, and one-sentence purpose summaries for all 39 sections.",
